...
function PromptCard({ post, handleTagClick, handleEdit, handleDelete }) {
    ...
    const handleClickUsersProfile = () => {
        router.push(`/profile/${post.creator._id}?username=${encodeURIComponent(post.creator.username)}`);
    };
    ...
    return (
        <div className='prompt_card'>
            <div className='flex justify-between items-start gap-5'>
                <div
                    className="flex-1 flex justify-between items-center gap-3 cursor-pointer"
                    onClick={handleClickUsersProfile}
                >
